...
# Stratify participants by baseline whole blood transcript levels of a public MAIT module to compare T1D-free intervals (figure 2E)
...
fig2E
pdf("./figures/fig2E.pdf", width = 4, height = 5)
print(fig2E)
dev.off()
# stats
p_top <- {
...
# Stratify participants by baseline whole blood transcript levels of a public Tc17 module to compare T1D-free intervals (figure 2G)
...
fig2G
pdf("./figures/fig2G.pdf", width = 4, height = 5)
print(fig2G)
dev.off()
# stats
p_top <- {
...
# Stratify participants by baseline whole blood transcript levels of a public Tc17 module to compare T1D-free intervals (supplementary figure 5C)
